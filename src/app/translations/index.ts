export const translations = {
  en: {
    ...
    about: {
      ...
      paragraph3:
        "When I’m in my spare time, you’ll usually find me swimming, catching a movie, or just binge-watching TV series. I’m also a terrible but enthusiastic FPS player—currently dividing my free screen time between Valorant and Splatoon 3.",
      skills: {
        development: {
          title: "Development",
          description:
  ...
  zh: {
    ...
    about: {
      title: "关于",
      paragraph1:
        "我是一名拥有超过8年经验的游戏开发者，致力于创造富有思想的游戏体验。从独立游戏到大型制作，我专注于打造技术扎实且引人入胜的系统。",
      paragraph2:
        "我的工作将技术专长与强烈的设计感相结合，始终将玩家体验放在中心位置。我相信打造直观、有意义且令人难忘的游戏。",
      paragraph3:
        "在开发之外，我喜欢探索新的游戏机制，指导初级开发者，并为游戏开发社区做出贡献。",
      skills: {
        development: {
          title: "开发",
          description:
            "Unity、Unreal Engine，使用C++、C#开发自定义工具",
        },
        design: {
          title: "设计",
    ...
    resume: {
      ...
      location: "瑞典 哥德堡",
      summary:
        "多学科背景的游戏开发者，将创意设计与强大的技术实现相结合。我希望在游戏设计与软件工程之间架起桥梁，创造引人入胜的端到端互动体验。",
      education: "教育背景",
      competencies: "专业能力",
      languagesSkill: "编程语言",
      enginesTools: "引擎与工具",
